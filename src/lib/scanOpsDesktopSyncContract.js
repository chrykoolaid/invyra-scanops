...
function buildCollaborationEnvelope(input = {}, context = getScanOpsGovernanceContext()) {
  ...
  return {
    ...
    ownerSessionId: input.ownerSessionId || context.sessionId || "session_scanops_pilot_001",
    ownerShiftId: input.ownerShiftId || context.shiftId || "shift_pilot_morning_001",
    conflictStatus,
...
export function getDesktopSyncOutboundQueue() {
  ...
  return [
    ...
    buildEnvelope({
      ...
      sourceRecordId: replenish?.sourceRecordId || "repl_pilot_aisle_3",
      ...
      payload: {
        replenishmentTaskId: "repl_pilot_aisle_3",
        aisle: "Aisle 3",
    ...
    buildEnvelope({
      ...
      sourceRecordId: context.sessionId || "session_scanops_pilot_001",
...
export function validateDesktopSyncPayload(envelope = {}) {
  ...
  if (envelope.sourceWorkflow === "Device / User / Shift Governance") {
    ...
    return {
      ...
      reviewReason: "Local pilot context event",
      issues: [],
      events,
    };
  }
