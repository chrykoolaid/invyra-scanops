...
export function writeMarkdownRecord({ item, reasonCode, selectedPercent, quantity, expiryDate, notes, status, requestId, currentPrice, selectedMarkdownPrice, currency, approvalRoleRequired, riskLevel, inventorySnapshotEvidence, inventorySnapshotRef, inventorySnapshotId, inventorySnapshotHash, inventoryRecordVersion }) {
  writeScanOpsRecord({
    recordType: "markdown",
    ...
    inventorySnapshotId: inventorySnapshotId || inventorySnapshotEvidence?.inventory_snapshot_id || null,
    inventorySnapshotRef: inventorySnapshotRef || inventorySnapshotEvidence?.inventory_snapshot_ref || null,
    inventorySnapshotHash: inventorySnapshotHash || inventorySnapshotEvidence?.inventory_snapshot_hash || null,
    inventoryRecordVersion: inventoryRecordVersion || inventorySnapshotEvidence?.inventory_record_version || null,
    payload: {
      inventory_snapshot_id: inventorySnapshotId || inventorySnapshotEvidence?.inventory_snapshot_id || null,
      inventory_snapshot_ref: inventorySnapshotRef || inventorySnapshotEvidence?.inventory_snapshot_ref || null,
      inventory_snapshot_hash: inventorySnapshotHash || inventorySnapshotEvidence?.inventory_snapshot_hash || null,
      inventory_record_version: inventoryRecordVersion || inventorySnapshotEvidence?.inventory_record_version || null,
      last_inventory_sync_at: inventorySnapshotEvidence?.last_inventory_sync_at || null,
      inventory_snapshot: inventorySnapshotEvidence?.inventory_snapshot || null,
...
export function writeMarkdownApprovalAudit({ requestId, action, actorName, actorRole, itemName, itemSku, itemBarcode, reason, selectedPercent, selectedMarkdownPrice, currentPrice, currency, inventorySnapshotRef, inventorySnapshotId, inventorySnapshotHash, inventoryRecordVersion, inventorySnapshot }) {
  writeScanOpsRecord({
    recordType: "markdown",
    status: action,
    itemName,
    ...
    inventorySnapshotRef: inventorySnapshotRef || null,
    inventorySnapshotHash: inventorySnapshotHash || null,
    inventoryRecordVersion: inventoryRecordVersion || null,
    payload: {
      inventory_snapshot_id: inventorySnapshotId || null,
      inventory_snapshot_ref: inventorySnapshotRef || null,
      inventory_snapshot_hash: inventorySnapshotHash || null,
      inventory_record_version: inventoryRecordVersion || null,
