    ...
    <header className="bg-card border-b border-border px-4 py-3">
      <div className="flex items-center justify-between gap-3">
        <div className="min-w-0">
          <h1 className="text-base font-bold text-foreground tracking-tight">Invyra ScanOps</h1>
          <p className="text-xs text-muted-foreground mt-0.5 truncate">Sarah M. · Staff · Grocery</p>
        </div>
