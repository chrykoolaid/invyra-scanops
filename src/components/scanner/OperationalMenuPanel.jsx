...
import { Activity, BadgeHelp, Bell, ClipboardCheck, Database, Gauge, GitPullRequest, Info, ListChecks, LogOut, MonitorSmartphone, RefreshCw, ScanLine, Settings, ShieldCheck, Ticket, Wifi, X } from "lucide-react";
...
export default function OperationalMenuPanel({ onClose }) {
  ...
  const active = () => {
    ...
    if (panel === "about") return <Section title="About ScanOps"><p className="text-sm font-semibold text-foreground">Invyra ScanOps</p><p className="text-xs text-muted-foreground">Stage T — Product Identity Review + Unknown Item Governance layer.</p></Section>;
    return null;
  };
