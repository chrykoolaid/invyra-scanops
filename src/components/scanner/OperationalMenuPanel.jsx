...
import { Activity, BadgeHelp, Bell, ClipboardCheck, Database, Gauge, Info, ListChecks, LogOut, MonitorSmartphone, RefreshCw, ScanLine, Settings, ShieldCheck, Ticket, Wifi, X } from "lucide-react";
...
export default function OperationalMenuPanel({ onClose }) {
  ...
  const active = () => {
    ...
    if (panel === "about") return <Section title="About ScanOps"><p className="text-sm font-semibold text-foreground">Invyra ScanOps</p><p className="text-xs text-muted-foreground">Stage R — Tasks + Sync Queue visibility layer.</p></Section>;
    return null;
  };
