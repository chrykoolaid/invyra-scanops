  ...
  return (
    <div className="min-h-screen bg-background flex flex-col overflow-x-hidden">
      ...
      <main data-scanops-scroll className="flex-1 overflow-y-auto px-4 py-4 pb-24 space-y-3">
        <section className="rounded-3xl border border-emerald-200 bg-emerald-50 p-4 text-emerald-900 shadow-sm">
          <div className="flex items-start gap-3">
            <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-white/70">
              <HelpCircle className="h-6 w-6" />
            </span>
            <div className="min-w-0 flex-1">
              <p className="text-[11px] font-black uppercase tracking-[0.16em] opacity-80">Operator Help</p>
              <h1 className="mt-1 text-2xl font-black leading-tight">What do I do next?</h1>
              <p className="mt-1 text-sm font-bold leading-snug opacity-90">Use this page for quick support only. UAT and release readiness evidence is no longer part of the handheld operator UI.</p>
            </div>
          </div>
        </section>
        ...
        <section className="rounded-3xl border border-amber-200 bg-amber-50 p-4 text-amber-900 shadow-sm">
          <div className="flex items-start gap-3">
            <CheckCircle2 className="mt-0.5 h-5 w-5 shrink-0" />
            <div>
              <p className="text-sm font-black">Help is read-only.</p>
              <p className="mt-1 text-xs font-bold leading-snug">This page does not bypass the bridge, mutate inventory, change pricing, adjust stock, print labels, or alter audit behavior.</p>
            </div>
          </div>
        </section>

        <button type="button" onClick={() => navigate("/")} className="flex min-h-12 w-full items-center justify-center gap-2 rounded-2xl bg-primary px-4 text-sm font-black text-primary-foreground active:scale-[0.98]">
