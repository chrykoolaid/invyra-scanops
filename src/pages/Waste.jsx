          ...
          <div className="space-y-4">
            <section className="bg-card rounded-2xl border border-border p-5">
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0"><h2 className="font-bold text-foreground">Scan item to record waste</h2><p className="text-sm text-muted-foreground mt-1 break-words">Record quantity and choose a reason from the dropdown. High-risk waste routes to supervisor review.</p></div>
              </div>
            </section>
