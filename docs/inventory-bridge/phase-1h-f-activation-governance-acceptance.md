...
- ScanOps-side operational readiness review.
...
ScanOps Phase 1H-F is acceptable only when the PR contains documentation files only and no runtime behavior can be inferred from the diff.
